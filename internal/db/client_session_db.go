...
type ClientSessionDB interface {
	...
	GetClientSessionByAccessToken(ctx context.Context, accessTokenHash string) (*model.ClientSession, error)

	// GetClientSessionByRefreshToken returns a client session by refresh token hash
	GetClientSessionByRefreshToken(ctx context.Context, refreshTokenHash string) (*model.ClientSession, error)

	// GetClientSessionByAuthCode returns a client session by auth code hash
	GetClientSessionByAuthCode(ctx context.Context, authCodeHash string) (*model.ClientSession, error)
	...
	UpdateClientSession(ctx context.Context, session *model.ClientSession) error
	...
	DeleteExpiredClientSessions(ctx context.Context) error
}
